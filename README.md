...
1. Creating an AWS Lambda function that queries an external API. (OpenWeatherMap API: Provides current and forecasted weather data. (Free tier available) <a> href="https://home.openweathermap.org/users/sign_in"/<a/>     
